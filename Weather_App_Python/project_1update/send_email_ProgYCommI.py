...
# Say hello (ehlo) to smtp server, we must follow the protocol ! here we are following the protocol 
# of sending messages by using the function such as echlo that tests the connection and starttls
...
# this part is a test part to ensure that sendemail function is working so it can be executed alone
